                ...
                <div className="flex flex-col lg:flex-row lg:items-start items-center gap-12 lg:pt-8">
                    ...
                    <div className="lg:w-1/2 flex flex-col items-start text-left space-y-6">
                        ...
                        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-green-200 shadow-sm">
                            ...
                            <span className="text-sm font-medium text-slate-700">{hero.trustBadge}</span>
                        </div>
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 leading-tight">
                            ...
                            <span className="text-green-600 relative whitespace-nowrap inline-block mt-2 lg:mt-3">
                                {hero.titleHighlight}
                                <svg className="absolute -bottom-2 sm:-bottom-3 left-0 w-full h-3 text-yellow-400 opacity-60" viewBox="0 0 100 20" preserveAspectRatio="none">
                        ...
                        <div className="w-full pt-4 border-t border-slate-200">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {/* Farmer Card */}
                                <a href="/auth?role=farmer" className="group flex flex-col p-5 rounded-2xl border-2 border-slate-200 hover:border-green-500 hover:shadow-lg bg-white transition-all duration-300 relative overflow-hidden">
                                ...
                                {/* Provider Card */}
                                <a href="/auth?role=provider" className="group flex flex-col p-5 rounded-2xl border-2 border-slate-200 hover:border-orange-500 hover:shadow-lg bg-white transition-all duration-300 relative overflow-hidden">
